...
//
// 	// get current data
// 	getStorageData(storageKey).then(result => {
// 		console.log("onMessage() => result [0]", JSON.stringify(result));
//
...
//
// 			// increment using request.field
// 			result[request.field] += Number(request.data);
// 			console.log("onMessage() => result [2]", JSON.stringify(result));
//
